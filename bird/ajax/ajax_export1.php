...
function magpie_export_callback() 
{
...
if ($echo) echo '<table class="helptable" cellpadding="0" cellspacing="0">';
...
$ret=array( 
'ret' => sprintf( '&quot;%1$s&quot; (ID %2$s) was successfully exported in %3$s seconds.', esc_html( get_the_title( $post->ID ) ), $post->ID, timer_stop() ),
